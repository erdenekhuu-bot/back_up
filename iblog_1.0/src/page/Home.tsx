    ...
    return (
        <div className='Home'>
                ...
                <div className="RightBar">
                    ...
                    <div>
                        <button style={{width: 149, height: 41, margin: 5, backgroundColor: 'white', color: '#E86B02', border: 'none', borderRadius: 10, cursor: 'pointer'}}>Бүртгүүлэх</button>
                        <button style={{width: 122, height: 41, margin: 5, backgroundColor: '#E86B02', color: 'white', border: 'none', borderRadius: 10, cursor: 'pointer'}}>Нэвтрэх</button>
                    </div>
                </div>
