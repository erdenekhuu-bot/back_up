    ...
    return (
            <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                <div style={{width: 478}}>
                        ...
                        <button style={{width: 478, height: 54, display: 'flex', justifyContent: 'center', alignItems: 'center', borderStyle: 'solid',borderColor:'#E86B02', borderRadius: 10}}><Link to='/create' style={{textDecoration: 'none'}}>Бүртгүүлэх</Link></button>
                </div>
            </div>
    )
}