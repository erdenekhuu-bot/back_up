        ...
        <div style={{backgroundColor: (!popUp ? 'white' : 'gray'),display: 'flex', justifyContent: 'space-between', 
                ...
                <div style={{display: 'flex', justifyContent: 'space-around', fontFamily: 'sans-serif'}}>
                    ...
                    <Link to='/home/add-post' style={{textDecoration:'none',color: 'white'}}>
                        <button style={{width: 111, height: 41, borderRadius: 10, border: 'none',margin: 5, backgroundColor: '#E86B02', color: 'white', alignItems: 'center', display: 'flex', justifyContent: 'center'}}><span style={{margin: 3}}>Post</span><img src={u_pen} alt="" /></button>
                    </Link>
