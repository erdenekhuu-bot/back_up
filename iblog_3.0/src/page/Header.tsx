        ...
        <div style={{backgroundColor: (!popUp ? 'white' : 'gray'),display: 'flex', justifyContent: 'space-around', alignItems: 'center', borderWidth: 1, borderStyle: 'solid', borderColor: '#E2E8EE'}}>
                ...
                <div style={{display: 'flex', justifyContent: 'space-around'}}>
                    ...
                    <div className='Popup' style={{position: 'absolute',top: '8.5%'}}>
                        ...
                        <div className='pop' style={{width: 270, height: 42, display: 'flex', alignItems: 'center', margin: 5, padding: 3,  cursor: 'pointer'}}><Link to='/loved-post' style={{textDecoration: 'none',color: 'black',}}><img src={u_heart} alt="" />Таалагдсан</Link></div>
                    ...
                    <button style={{width: 111, height: 41, borderRadius: 10, borderTop: 'none', borderRight:'none',borderLeft:'none', borderWidth: 1, borderStyle: 'solid', borderColor: '#E86B02', margin: 5, backgroundColor: 'white'}}><Link to='/profile' style={{textDecoration: 'none',color: '#E86B02'}}><img src={w_user} alt=''/> Профайл</Link></button>
                </div>
        </div>
    )
}